---
title: AWS ASG Deployment
description: Deploy kmagent across an Auto Scaling Group with zero manual per-instance work.
---
...
<Steps>
  <Step>
  ### Step 1: Append the User Data Script
  ...
  <Step>
  ### Step 2: Apply User Data to Launch Template
  ...
  <Step>
  ### Step 3: Roll Out to Existing Instances
