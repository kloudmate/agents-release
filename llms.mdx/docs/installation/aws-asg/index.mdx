...
<Steps>
  <Step>
    Step 1: Store API Key in SSM Parameter Store [#step-1-store-api-key-in-ssm-parameter-store]
  ...
  <Step>
    Step 2: IAM Permissions [#step-2-iam-permissions]
  ...
  <Step>
    Step 3: Create the User Data Script [#step-3-create-the-user-data-script]
  ...
  <Step>
    Step 4: Apply User Data to Launch Template [#step-4-apply-user-data-to-launch-template]
  ...
  <Step>
    Step 5: Roll Out to Existing Instances [#step-5-roll-out-to-existing-instances]
